...
<body>
    ...
    <script>
        ...
        function drawGlobalImportance() {{
            ...
            // Separar y ordenar para temperatura (descendiente, más importante primero)
            const sortedTemp = labels.map((l, idx) => ({{
                label: l,
                val: tempValues[idx]
            }})).sort((a, b) => b.val - a.val);
            
            // Separar y ordenar para humedad (descendiente, más importante primero)
            const sortedHum = labels.map((l, idx) => ({{
                label: l,
                val: humValues[idx]
            }})).sort((a, b) => b.val - a.val);
